...
!function(e){"use strict";e(function(){var c=e("pre");c.click(function(c){c.preventDefault();var t=e(this);e(".wpcs-code-select").remove();var s=e('<textarea class="wpcs-code-copy" spellcheck="false">'+t.text()+"</textarea>");t.hide().after(s),jQuery().autosize?s.autosize().select():s.select()}),c.css("position","relative"),c.hover(function(){e(this).append('<span class="wpcs-code-select">Click to select</span>'),e(".wpcs-code-select").fadeIn()},function(){e(".wpcs-code-select").remove()}),e(document).on("focusout",".wpcs-code-copy",function(c){c.preventDefault(),e(this).prev("pre").show(),e(this).remove()})})}(jQuery);