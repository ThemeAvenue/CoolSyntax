...
!function(e){"use strict";e(function(){var t=e("pre");t.click(function(t){t.preventDefault();var c=e(this),s=c.text(),o=e('<textarea class="wpcs-code-copy" spellcheck="false">'+s+"</textarea>");c.hide().after(o),o.autosize().select()}),t.css("position","relative"),t.hover(function(){e(this).append('<span class="wpcs-code-select">Click to select</span>'),e(".wpcs-code-select").fadeIn()},function(){e(".wpcs-code-select").fadeOut().remove()}),e(document).on("focusout",".wpcs-code-copy",function(t){t.preventDefault(),e(this).prev("pre").show(),e(this).remove()})})}(jQuery);