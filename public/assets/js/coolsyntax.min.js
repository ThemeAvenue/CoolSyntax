...
!function(e){"use strict";e(function(){var t=e("pre");t.css("position","relative"),t.each(function(){var t=e(this),c=e(this).outerHeight(),s=e(this).css("marginBottom");t.click(function(o){o.preventDefault(),e(".wpcs-code-select").remove();var n=e('<textarea class="wpcs-code-copy" spellcheck="false">'+t.text()+"</textarea>");n.css({height:c,marginBottom:s}),t.hide().after(n),n.select()}),t.hover(function(){e(this).append('<span class="wpcs-code-select">Click to select</span>'),e(".wpcs-code-select").fadeIn()},function(){e(".wpcs-code-select").remove()})}),e(document).on("focusout",".wpcs-code-copy",function(t){t.preventDefault(),e(this).prev("pre").show(),e(this).remove()})})}(jQuery);