...
!function(t){"use strict";t(function(){var e=t("pre.coolsyntax");e.each(function(e,c){Prism.highlightAll(!1,function(){var o=t(c),n=o.outerHeight(),i=o.css("marginBottom"),s={hint:t("<span>",{"class":"wpcs-code-select",text:"Click to select"}),textarea:t("<textarea>",{"class":"wpcs-code-copy",id:"wpcs-"+e,spellcheck:"false",html:o.text(),outerHeight:n})};s.textarea.css("marginBottom",i),o.click(function(t){t.preventDefault(),s.hint.remove(),o.hide().after(s.textarea),s.textarea.select()}),o.hover(function(){s.hint.appendTo(t(this))},function(){s.hint.remove()})})}),t(document).on("focusout",".wpcs-code-copy",function(e){e.preventDefault(),t(this).prev("pre").show(),t(this).remove()})})}(jQuery);